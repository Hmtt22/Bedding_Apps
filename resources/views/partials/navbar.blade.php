        ...
        <div class="ms-auto">
            <ul class="list-unstyled">
                <li class="dropdown pc-h-item header-user-profile">
                    ...
                    <!-- FOTO DI HEADER (SAMA DENGAN DROPDOWN) -->
                    <a class="pc-head-link dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown"
                       href="#" role="button" aria-haspopup="false" data-bs-auto-close="outside" aria-expanded="false">
                        <img src="{{ asset('assets/images/user.png') }}" alt="user-image" class="user-avtar">
                        ...
                        <div class="dropdown-header">
                            <div class="d-flex mb-1">
                                <div class="flex-shrink-0">
                                    ...
                                    <!-- FOTO DI DALAM DROPDOWN (SAMA DENGAN HEADER) -->
                                    <img src="{{ asset('assets/images/user.png') }}" alt="user-image" class="user-avtar wid-35">
                                ...
                                <form action="{{ route('logout') }}" method="POST" style="display:inline;">
                                    ...
                                    <button type="submit" class="pc-head-link bg-transparent">
                                        <i class="ti ti-power text-danger">logout</i>
                                    </button>
                                </form>
                        ...
                        <ul class="nav drp-tabs nav-fill nav-tabs" id="mydrpTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="drp-t2" data-bs-toggle="tab" data-bs-target="#drp-tab-2"
                                        type="button" role="tab" aria-controls="drp-tab-2" aria-selected="false">
